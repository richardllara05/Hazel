...
#define HZ_CORE_INFO(...) \
::Hazel::Log::GetCoreLogger()->info(__VA_ARGS__)

#define HZ_CORE_TRACE(...) \
::Hazel::Log::GetCoreLogger()->trace(__VA_ARGS__)

#define HZ_CORE_FATAL(...) \
::Hazel::Log::GetCoreLogger()->fatal(__VA_ARGS__)
...
::Hazel::Log::GetClientLogger()->info(__VA_ARGS__)

#define HZ_CLIENT_TRACE(...) \
::Hazel::Log::GetClientLogger()->trace(__VA_ARGS__)

#define HZ_CLIENT_FATAL(...) \
::Hazel::Log::GetClientLogger()->fatal(__VA_ARGS__)